...
/**
* This functions returns the byte at a depth into the buffer without popping it off
* @param depth the bytes to seek into the buffer
* @return the byte at the specified depth
*/
