...
#define SOFT_BUFF_SIZE 0x80
#define SOFT_BUFF_MASK 0x7F
...
volatile unsigned char rxrp = 0;
volatile unsigned char rxwp = 0;
volatile unsigned char rxbc = 0;
volatile unsigned char rxbuffers[SOFT_BUFF_SIZE];

// Transmit variables
volatile unsigned char tx_char = 0;
volatile unsigned char txrp = 0;
volatile unsigned char txwp = 0;
volatile unsigned char txbc = 0;
